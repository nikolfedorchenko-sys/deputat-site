...
const SEED_SETTINGS = {
  ...
  // Про депутата
  bio: 'Юрій Станіславович Тихонович — депутат Київської міської ради IX скликання ' +
       'від округу №12 (Солом’янський район), перший заступник голови постійної комісії ' +
       'з питань житлово-комунального господарства та паливно-енергетичного комплексу, ' +
       'член правління ПрАТ «ХК «Київміськбуд».\n\n' +
       'Народився 21 червня 1970 року в Києві. Кандидат юридичних наук, ' +
       'інженер-будівельник. Понад два десятиліття професійно працює у сфері міського ' +
       'будівництва та житлово-комунального господарства столиці.',
  education:
    '2015 — Київський національний університет імені Тараса Шевченка, ' +
    'науковий ступінь кандидата юридичних наук.\n' +
    '2011 — Київський національний університет будівництва і архітектури, ' +
    'спеціальність «Міське будівництво та господарство» (інженер-будівельник).\n' +
    '2007 — Київський славістичний університет, спеціальність «Менеджмент організацій».',
  career:
    'з 2020 — заступник директора ТОВ «АЙ СІ ТІ»; член правління ПрАТ «ХК «Київміськбуд».\n' +
    '2013 — засновник ТОВ «ІБК «Столиця майбутнього».\n' +
    '2011 — засновник ТОВ «ІБК «Альянс капітал».\n' +
    '2006–2008 — заступник директора ВБК «Компроміс-ТВ».\n' +
    '2005–2007 — помічник-консультант народних депутатів України.\n' +
    '2004–2006 — заступник директора КП «Інженерний центр» КМДА.',
  ...
  // Контакти / приймальня
  contact_address: '03057, м. Київ, вул. Михайла Брайчевського, 9 (Солом’янський район)',
  contact_phones: '(063) 517-06-39, (044) 456-59-21, (044) 456-59-22',
  contact_phones_note: '',
  contact_email: 'tykhonovych.yurii@kmr.gov.ua',
  contact_email_reception: 'TykhonovychYS.Prijmalnya@gmail.com',
  contact_hours: 'Пн–Пт, 10:00–16:00. Особистий прийом депутата — за попереднім записом',
  facebook_url: 'https://www.facebook.com/YuriiTykhonovych/',
  kyivrada_url: 'https://old.kmr.gov.ua/uk/users/tykhonovychyurii',
...
if (achievementsCount === 0) {
  ...
  const seed = [
    ['2287', 'мешканців отримали матеріальну допомогу на 7 975 553 грн (за 2025 рік)', 1],
    ['95', 'рішень Київради ухвалено за участі депутата (IX скликання)', 2],
    ['352', 'депутатських звернення опрацьовано за виборців у 2025 році', 3],
    ['17 млн грн', 'спрямовано на капітальні ремонти шкіл і садків округу (2021–2025)', 4],
  ];
...
if (galleryCount === 0) {
  const gseed = [
    ...
    ['/img/gallery/g25.jpg', 'Депутат Юрій Тихонович'],
    ['/img/gallery/g26.jpg', 'У робочому кабінеті'],
    ['/img/gallery/g27.jpg', 'Робота на об’єктах округу'],
    ['/img/gallery/g28.jpg', 'Прийом громадян'],
    ['/img/gallery/g29.jpg', 'Матеріальна допомога мешканцям'],
    ['/img/gallery/g30.jpg', 'Робочі зустрічі'],
    ['/img/gallery/g31.jpg', 'Підтримка поранених військових'],
    ['/img/gallery/g32.jpg', 'Зустріч із захисниками'],
    ['/img/gallery/g33.jpg', 'З бійцями підрозділу'],
    ['/img/gallery/g34.jpg', 'Спорядження для фронту'],
    ['/img/gallery/g35.jpg', 'Передача зарядних станцій та зв’язку'],
    ['/img/gallery/g36.jpg', 'Передача техніки військовим'],
    ['/img/gallery/g37.jpg', 'Доставка на передову'],
